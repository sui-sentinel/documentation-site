...
Understanding the language of prompt injection is essential for both attackers and defenders on the Red Sentinel platform. This glossary covers the key terms and concepts you'll encounter.
...
The hidden instructions that define a model's behavior, constraints, and personality. In Red Sentinel, defenders craft system prompts to protect secrets while maintaining convincing character performance.
...
An AI agent deployed on Red Sentinel with defined instructions, a protected secret, and a prize pool for successful attacks.
