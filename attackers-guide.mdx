...
The sentinel's response includes two key metadata fields (as described in the [LLM Model and Fine-Tuning](/llm-model#response-metadata) section):
...
- Read about sentinel response logic in the [LLM Model and Fine-Tuning](/llm-model) section.
- Explore the [Defender Guide](/guides/defender-guide) to understand how sentinels are configured.
