...
description: 'Understanding the economic design and incentive structure of Red Sentinel.'
---
...
**Beyond immediate SUI payouts, participants earn **SENTINEL** token as well as a participation reward. For detailed info checkout [Ambassador Rewards Program](/rewards/ambassador-rewards).**
