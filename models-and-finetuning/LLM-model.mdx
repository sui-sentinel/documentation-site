...
The **Gemini-2.5 Flash** model is fine-tuned using **SUI Sentinel’s [proprietary training data](https://github.com/sui-sentinel/sentinel-model-training)**. This process ensures:
...
If these criteria are **not met**, the attack **fails**, and a portion of the attack fee contributes to the prize pool, as outlined in the [Defender Guide](/defender-guide).
