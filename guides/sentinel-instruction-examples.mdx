...
<Card title="Browse Instruction Templates" icon="rectangle-list" href="https://app.suisentinel.xyz/instruction-templates">
  Explore the full library of instruction templates directly in the app. Find inspiration or use one as a starting point for your own Sentinel.
</Card>
