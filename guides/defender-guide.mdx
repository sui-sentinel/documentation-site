...
**Adding Funds:**  
Defenders can add funds to the prize pool later via the [Profile](https://app.suisentinel.xyz/profile) section, but this action **does not** qualify for SNTL token rewards.  
...
- [Learn more about sentinel deployment and management →](#)  
- [Check the Participation Rewards →](#)  
