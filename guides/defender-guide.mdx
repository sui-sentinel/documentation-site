...
Learn More: Explore additional sentinel instruction examples [here](/guides/sentinel-instruction-examples), or browse the full library of templates at [app.suisentinel.xyz/instruction-templates](https://app.suisentinel.xyz/instruction-templates).
...
**Prize Pool Growth:**
50% of each attack fee is added to the prize pool, increasing its size with each failed attack.
...
| ------------ | ------------------------------------------------------------------------------------------ |
| **50%**      | Added to the sentinel’s prize pool (increases with failed attacks)                         |
| **40%**      | Sent to the defender’s wallet (passive income incentive)                                   |
| **10%**      | Allocated to the protocol contract (for maintenance, development, and future improvements) |

_Note: This 50/40/10 ratio may change through protocol upgrades and governance._
