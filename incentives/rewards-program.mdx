...
description: 'Earn SENTINEL points by completing on-chain and social missions. Climb the leaderboard and unlock exclusive rewards.'
---

## Overview

The Sui Sentinel Rewards Program is designed to incentivize user engagement and bolster the security of the AI agent ecosystem. By participating, you can earn Sentinel Points ($SENTINEL$) for completing various on-chain and social missions.
...
To be eligible to earn $SENTINEL$ for **any mission (including on-chain activities)**, you must first connect your Sui wallet to either a **Twitter (X)** or **Discord** account. This is a necessary step to activate your rewards profile and begin tracking your progress.
...
3.  **Start Completing Missions:** Once your account is set up, you will automatically start earning $SENTINEL$ for completing any of the missions listed below.

## Missions & SENTINEL Points

Users earn Sentinel Points ($SENTINEL$) by completing missions across two categories: On-Chain and Social Media. The program's points are named "Sentinel Points" with the symbol "SENTINEL".

### On-Chain Missions

These missions reward you for direct interaction with the Sui Sentinel protocol.

| Mission                     | SENTINEL Points | Frequency      |
| :-------------------------- | :-------------- | :------------- |
| **Attack a Sentinel**       | Dynamic         | Per Occurrence |
| **Launch a Sentinel**       | +200 SENTINEL   | 1 per week     |
| **Add Funds to a Sentinel** | x25 / SUI       | Per Occurrence |
| **Defeat a Sentinel**       | +300 SENTINEL   | Per Occurrence |
...
| Mission                          | SENTINEL Points | Frequency   |
| :------------------------------- | :-------------- | :---------- |
| **Follow Sui Sentinel on X**     | +100 SENTINEL   | One-time    |
| **Retweet a Sui Sentinel post**  | +20 SENTINEL    | Max 10/week |
| **Share Post with #SuiSentinel** | +30 SENTINEL    | Max 3/week  |
| **Join Sui Sentinel Telegram**   | +100 SENTINEL   | One-time    |
| **Engage in Telegram**           | +20 SENTINEL    | Max 10/week |
| **Join Sui Sentinel Discord**    | +100 SENTINEL   | One-time    |
| **Engage in Discord**            | +20 SENTINEL    | Max 10/week |

## Why Join?

- **Earn Real Rewards:** Your skills in prompt engineering and security testing are directly rewarded with $SENTINEL$ points, which will have future value within the ecosystem.
...
- **Join the Community:** Follow us on [**X (Twitter)**](https://twitter.com/intent/follow?screen_name=suisentinal), join our [**Telegram**](https://t.me/suisentinel), and our [**Discord**](https://discord.gg/bAz9g9u69K) for social missions and updates.
